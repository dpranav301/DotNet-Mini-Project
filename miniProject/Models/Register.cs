...
namespace miniProject.Models
{
    public class Register
    {
        ...
        public static List<Register> GetAllRegUser()
        {
            ...
            cn.ConnectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Project;Integrated Security=True";
            try
            {
                cn.Open();
        ...
        public static int GetLoginUserNo(string LoginName, string Password)
        {
            int n = -1;
